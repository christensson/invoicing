...
module.exports.getDbPromise = function() {
    return dbDeferred.promise;
};

module.exports.connect = function() {
    mongodb.connect(mongourl, function(err, dbInstance) {
        if (err) {
...
function dbopPromise() {
  return module.exports.getDbPromise();
}
...
module.exports.getStats = function(uid, companyId) {
  ...
  var jobs = [
    ...
    countAllDocsPromise('article', {'isValid': true, 'uid': ouid}),
  ];
  ...
  if (companyId !== "undefined" && companyId !== "null") {
    ...
    jobs.push(countAllDocsPromise('article', {'isValid': true, 'uid': ouid, 'companyId': ocompanyId}));
  }
